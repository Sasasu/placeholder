...
impl<'a> ::std::default::Default for &'a PackageShard {
    fn default() -> &'a PackageShard {
        <PackageShard as ::protobuf::Message>::default_instance()
    }
}
...
impl<'a> ::std::default::Default for &'a PingPong {
    fn default() -> &'a PingPong {
        <PingPong as ::protobuf::Message>::default_instance()
    }
}
